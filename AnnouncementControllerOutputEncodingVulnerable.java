...
public class AnnouncementController {
    ...
    @GetMapping("/manage")
    public String showAnnouncementManager(HttpServletRequest req, Model model) {
        
        User user = userRepository.getUserById((Integer) req.getSession(false).getAttribute("id"));
        // Only show courses owned by this teacher
 ...
 @PostMapping("/delete/{id}")
    public String deleteAnnouncement(
        ...
        try {
            // Get the announcement first to verify course ownership
            ...
            // Verify teacher owns the course this announcement belongs to
